...
<!--
 ...
 -->
	<div class="container row vMargin16" style=" float: none; margin: auto; width: 80%; display: flex;">
		<div class="col-4 bgRed">
		<div class="row textWhite padding32" style="align-items: stretch; flex: 1;">
		...
		<!--
		 ...
		 -->
			<div class="row padding32 bgDarkGrey textWhite">
				<p>
